...
Public Class Exercises
    ...
    Sub LoadQuestion()
        ...
        adapter.Fill(dt)
        adapter.Fill(ds, "AddQuestions")
        cmd.ExecuteNonQuery()
        con.Close()

        Dim randomnumber As New Random
        Dim answerrow As Integer = randomnumber.Next(0, ds.Tables(0).Rows.Count)

        Image1.ImageUrl = dt.Rows(answerrow)(1).ToString()
        Button1.Text = dt.Rows(randomnumber.Next(0, ds.Tables(0).Rows.Count))(0).ToString()
        Button2.Text = dt.Rows(randomnumber.Next(0, ds.Tables(0).Rows.Count))(0).ToString()
        Button3.Text = dt.Rows(randomnumber.Next(0, ds.Tables(0).Rows.Count))(0).ToString()
        '   CHECK CODE
        While Button1.Text <> dt.Rows(answerrow)(0).ToString() And Button2.Text <> dt.Rows(answerrow)(0).ToString() And Button3.Text <> dt.Rows(answerrow)(0).ToString()
            Button1.Text = dt.Rows(randomnumber.Next(0, ds.Tables(0).Rows.Count))(0).ToString()
            Button2.Text = dt.Rows(randomnumber.Next(0, ds.Tables(0).Rows.Count))(0).ToString()
            Button3.Text = dt.Rows(randomnumber.Next(0, ds.Tables(0).Rows.Count))(0).ToString()
        End While
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If Button1.Text = Session("Answer") Then
            ...
            Score_Label.Text = DirectCast(Session("Score"), Integer)
    ...
    Protected Sub Exit_Button_Click(sender As Object, e As EventArgs) Handles Exit_Button.Click
        ...
        Dim SQL As String = "INSERT INTO [TrackScore]  ([Username], [QuizScore], [Date])" &
            "VALUES ('" & Session("Username") & "','" & Session("Score") & "', '" & DateTime.Now.ToString("MM/dd/yyy HH:mm:ss") & "')"
        Dim cmd As New SqlCommand(SQL, con)
        con.Open()
        cmd.ExecuteNonQuery()
        con.Close()
