    ...
    <form id="form1" runat="server">
            ...
            <table class="auto-style1">
                ...
                <tr>
                    <td class="auto-style2">&nbsp;</td>
                    <td>
                <asp:Button ID="Button2" runat="server" Text="Progress" BackColor="#FFCC00" BorderColor="#999999" BorderStyle="Double" BorderWidth="10px" CssClass="auto-style3" Font-Bold="False" Font-Names="Malgun Gothic" ForeColor="#666666" PostBackUrl="~/Exercises.aspx" Width="298px" />
                    </td>
                    <td>&nbsp;</td>
                </tr>
            </table>
